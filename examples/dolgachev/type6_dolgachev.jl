...
f = HomotopyContinuation.System([
    ...
    2.911589*a_1-.48565*a_2-.523357*b_1-.646118*b_2+.30993*c_1+.36067*c_2+.0452546*d_1+.429238*d_2+.0146597,
...
HomotopyContinuation.solutions(sols; only_nonsingular=true)
...
p_list = map(i-> map(j -> CC(j), i), HomotopyContinuation.solutions(sols; only_nonsingular=true))
